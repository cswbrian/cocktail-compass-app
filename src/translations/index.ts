export const translations = {
  en: {
    ...
    pleaseSetUsername: "Please set up your username to continue",
    usernameRequirements: "Username requirements:",
    usernameMaxLength: "Maximum 30 characters",
    usernameLowercaseOnly: "Only lowercase letters, numbers, and periods allowed",
    usernameNoConsecutivePeriods: "No consecutive periods",
    usernameNoPeriodsStartEnd: "Cannot start or end with a period",

...
export default function Step2() {
  ...
  const { selectedFlavors, handleFlavorSelect } =
    useCocktail();
  ...
  return (
    ...
    >
      ...
      <div className="space-y-4">
        {(
          Object.entries(FLAVOR_GROUPS) as [
            FlavorGroupKey,
            string[],
          ][]
        ).map(([groupKey, flavors]) => (
              ...
              {flavors.map(flavor => (
                <Button
                  ...
                  className={`${
                    selectedFlavors.includes(flavor) &&
                    flavorClasses[
                      flavor as keyof typeof flavorClasses
                    ]
                  }`}
                >
                  {
                    t[
                      flavor.toLowerCase() as TranslationKey
                    ]
                  }
                </Button>
              ))}
